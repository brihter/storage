...
const TypeFormatter = typesLookup => {
  ...
  const getConstructors = typeDefinitions => {
    ...
    const signatures = typeDefinitions.map(t => {
      ...
      return {
        ...
        parameters: t.parameters
          ...
          .join(', '),
        returnType:
          (_a = t.returnType) === null || _a === void 0 ? void 0 : _a.valueType
      }
    })
    const list = () =>
    ...
    const describeOne = type => {
      ...
      let returns = ''
      returns += `- \`${
        (_a = type.returnType) === null || _a === void 0 ? void 0 : _a.valueType
      }\``
      if (
        ((_b = type.returnType) === null || _b === void 0
          ? void 0
          : _b.description) &&
        ((_c = type.returnType) === null || _c === void 0
          ? void 0
          : _c.description.length) > 0
      ) {
        returns += `- ${
          (_d = type.returnType) === null || _d === void 0
            ? void 0
            : _d.description
        }`
      }
